    ...
    try {
      ...
      const response = await axios.post(
        'https://api.openai.com/v1/chat/completions',
        {
          ...
          temperature: 0.85, // Control the randomness of the generated response
        },
        {
          headers: {
